...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    subtitle: "Building a unified component library for 4 product teams",
    ...
    sections: [
      {
        type: "text",
        heading: "Overview",
        body: "[Placeholder] Four product teams were building with inconsistent components, leading to fragmented user experiences and duplicated design effort. I led the creation of a shared design system that unified the product suite and cut design-to-dev handoff time by 50%.",
      },
      {
        type: "text-image",
        heading: "Auditing the Landscape",
        body: "[Placeholder] I catalogued 340+ unique components across 4 products, finding 60% overlap with inconsistent implementations. I mapped these to a core set of 85 foundational components and presented the consolidation plan to leadership.",
        images: ["/images/case-study-2-audit.jpg"],
        layout: "right",
      },
      {
        type: "text-image",
        heading: "Building the Foundation",
        body: "[Placeholder] I established design tokens for color, typography, spacing, and elevation. Each component was designed with accessibility baked in — WCAG AA compliant, keyboard navigable, and screen-reader tested. I partnered closely with engineering to ensure Figma components mapped 1:1 to React components.",
        images: ["/images/case-study-2-tokens.jpg"],
        layout: "left",
      },
      {
        type: "image",
        heading: "The Component Library",
        images: ["/images/case-study-2-library.jpg"],
        caption: "[Placeholder] A selection of core components from the design system",
      },
      {
        type: "stat-block",
        heading: "Impact",
        stats: [
          { value: "50%", label: "Faster design-to-dev handoff" },
          { value: "85", label: "Core components shipped" },
          { value: "4", label: "Product teams unified" },
          { value: "92%", label: "Adoption rate in 3 months" },
        ],
      },
    ],
  },
